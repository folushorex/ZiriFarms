...
import Navigation5 from "../assets/Navigation Arrow 5.png";
import ShopNowButton2 from "../assets/Shop Now Button2.png";
import {Link} from 'react-router-dom';
import "../styles/Organictwo.css";
...
function Organictwo() {
  return (
    ...
    <div className="OgranicFarmGroup" style={{width: 1108, height: 356,left:130, position: 'relative'}}>
     ...
     <Link to ="/"> 
    <img className="NavIcon4" src={Navigation5} alt="" style={{width: 40, height: 40, left: 700, top: 200, position: 'absolute'}}/>
     </Link>
   
      
    <Link to ="/Shop"> 
    <img className="ShopNowButton2" src={ShopNowButton2} alt="" style={{width: 176, height: 53, left: 0, top: 301, background: '#0E5B0D', borderRadius: 48, textAlign: 'center', color: 'white', fontSize: 14, fontFamily: 'Poppins', fontWeight: '700', letterSpacing: 0.56, wordWrap: 'break-word' ,position: 'absolute'}}/>
    </Link> 
