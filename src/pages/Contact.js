...
function Contact() {
  ...
  <img className="RingerVolume"src={Ringer} alt="" style={{width: 50, height: 30, left: 68, top: 195, position: 'absolute'}}/>
  <img className="Website"src={Website} alt="" style={{width: 50, height: 30, left: 68, top: 301, position: 'absolute'}} />
  ...
  <Link to="https://wa.me/2348023654347">
    <img className="Facebook" src={Facebook} alt="" style={{width: 26, height: 26}} /></Link>

    <Link to="https://wa.me/2348023654347">
    <img className="Instagram"src={Instagram} alt="" style={{width: 26, height: 26}}/></Link>

    <Link to="https://wa.me/2348023654347">
    <img className="Linkedin"src={LinkedIn} alt=""style={{width: 26, height: 26}}/></Link>
    <Link to="https://wa.me/2348023654347">
    <img className="Youtube" src={Youtube} alt="" /></Link>
  </div>
  <Link to="https://wa.me/2348023654347">
  <img className="Envelope" src={Email} alt="" style={{width: 50, height: 30, left: 71, top: 250, position: 'absolute'}}/></Link>
